...
'''
netk is U_{4-k}
pnet concatenats previously tained networks, need to modify manually based on the step
'''
...
class ConcatenatedUNet(nn.Module):
    def __init__(self):
        ...
        '''
        self.net4.load_state_dict(torch.load('D:/thesis/results/final_feed_step_0_train_phase_1/model_weights_epoch22.pt', map_location=device))
        self.net3.load_state_dict(torch.load('D:/thesis/results/final_feed_run1_step1_train_phase_1/model_weights_epoch22.pt', map_location=device))
        self.net2.load_state_dict(torch.load('D:/thesis/results/final_feed_run1_step2_train_phase_1/model_weights_epoch18.pt', map_location=device))
        self.net1.load_state_dict(torch.load('D:/thesis/results/final_feed_run1_step3_train_phase_1/model_weights_epoch18.pt', map_location=device))
        self.net4.eval()
        self.net3.eval()
        self.net2.eval()
        self.net1.eval()
...
pnet = ConcatenatedUNet().to(device)
...
for i in range(train_phases):
    ...
    net.train_on(train_data, val_data, pnet, **train_params_cur)
